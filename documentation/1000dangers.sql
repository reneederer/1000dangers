...
create table papconnection(source_id int, destination_id int, 1000dangersbook_id int, source_offset_x int, source_offset_y int, destination_offset_x int, destination_offset_y int, title varchar(200), primary key(source_id, destination_id, 1000dangersbook_id), foreign key(source_id) references papelement(id), foreign key(destination_id) references papelement(id), foreign key(1000dangersbook_id) references 1000dangersbook(id));
...
insert into papconnection(source_id, destination_id, 1000dangersbook_id, source_offset_x, source_offset_y, destination_offset_x, destination_offset_y, title) values(1, 2, 1, 0, 0, 0, 0, "Titel");
insert into papconnection(source_id, destination_id, 1000dangersbook_id, source_offset_x, source_offset_y, destination_offset_x, destination_offset_y, title) values(1, 3, 1, 0, 0, 0, 0, "Titel");
insert into papconnection(source_id, destination_id, 1000dangersbook_id, source_offset_x, source_offset_y, destination_offset_x, destination_offset_y, title) values(2, 4, 1, 0, 0, 0, 0, "Titel");
