...
create table papconnection(source_id int, destination_id int, 1000dangersbook_id int, source_offset_x int, source_offset_y int, destination_offset_x int, destination_offset_y int, title varchar(200), foreign key(source_id) references papelement(id), foreign key(destination_id) references papelement(id), foreign key(1000dangersbook_id) references 1000dangersbook(id));
